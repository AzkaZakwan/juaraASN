...
<body class="bg-[#F3F3F3]" style="font-family: 'Poppins', sans-serif;">
    ...
    <main class="lg:ml-64 min-h-screen p-4 sm:p-6 lg:p-8 mt-16 lg:mt-0">
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-5 sm:p-8 lg:p-10 w-full">
                ...
                <form action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[180px_1fr] gap-3 lg:gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Kosongkan atau isi 0 untuk paket gratis. Jika harga lebih dari 0, paket otomatis premium
                                dan
                                pembahasan aktif.
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[180px_1fr] gap-3 lg:gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-2">
                                Opsional. Jika diisi, soal dari Excel otomatis masuk ke bank soal dan langsung terhubung
                                ke
                                paket ini.
                            </p>
                        </div>
