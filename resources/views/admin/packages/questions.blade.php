                ...
                <div class="xl:col-span-5 bg-white rounded-3xl shadow-lg overflow-hidden">
                    ...
                    <div class="px-4 pb-4 h-[500px] overflow-y-auto space-y-3">
                        ...
                        @forelse ($questions as $question)
                            ...
                            <label
                                class="question-item block border border-gray-200 rounded-2xl p-4 hover:border-[#FF6B2C] transition cursor-pointer"
                                data-category="{{ $category }}">

                                <div class="flex gap-3">

                                    <input type="checkbox" name="questions[]" value="{{ $question->id }}"
                                        class="question-checkbox mt-1 w-5 h-5" data-category="{{ $category }}"
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex flex-wrap gap-2 mb-2">
                                            ...
                                            <span
                                                class="sub-category inline-block text-xs font-bold px-3 py-1 rounded-full bg-gray-100 text-gray-600">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="text-center">
                                    <div id="countTWK"
                                        class="bg-[#D9D9D9] rounded-lg h-12 mb-2 flex items-center justify-center font-bold">
                                        0
                                    </div>
